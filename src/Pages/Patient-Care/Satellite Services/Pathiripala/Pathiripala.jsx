...
const services = [
    ...
    { icon: "fa fa-ambulance", title: "Ambulance Services" },
];
...
const Pathiripala = () => {
    ...
    const handleAppointmentSubmit = (e) => {
        e.preventDefault();
        // TODO: wire this up to your appointment/mail endpoint
                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            ...
                            <h2 className="pt-about-title">About Our Multi Speciality Clinic - Pathiripala</h2>
                            <p>
                                The Multi Speciality Clinic - Pathiripala was established with the aim of
                            ...
                            <p>
                                ...
                                Pathiripala offers a full suite of medical solutions including consultations
                                with specialists, effective diagnostics, health check-ups, and pharmacy under
                                one roof.
                            </p>
                        </div>
                        <div className="col-lg-6">
                            <div className="gm-about-image pt-about-image">
                                <img className="img-fluid" src={aboutImg} alt="PK Das Multi Speciality Clinic - Pathiripala" />
            ...
            <section className="pt-contact">
                            ...
                            <div className="pt-contact-info">
                                ...
                                <div className="pt-contact-item">
                                    ...
                                    <div>
                                        ...
                                        <p>1st floor, Pathiripala Trade center, Pathiripala, Palakkad</p>
                                    </div>
                                </div>
                ...
                <div className="pt-map">
                    <iframe
                        ...
                        allowFullScreen=""
                        loading="lazy"
                        title="PK Das Multi Speciality Clinic - Pathiripala location"
                    ></iframe>
                </div>
            </section>
                    ...
                    <div className="pt-video-modal-inner" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="pt-video-frame">
                            <iframe
                                ...
                                title="Pathiripala clinic video"
                                frameBorder="0"
